    ...
    <div className={className} {...rest}>
      <Grid container spacing={4}>
        <Grid item xs={12} sm={12} md={6}>
          <SectionHeader
            label="Precious Metals Deals"
            title={
              <span>
                <Typography component="span" variant="inherit" color="primary">
                  You can buy and sell
                </Typography>{" "}
                precious metals against TRY, USD and EUR with the most
                competitive rates.
              </span>
            }
            subtitle="The Gold subject to deal has 99,5% purity (995/1000) while silver and platinum has 100% purity (1000/1000). The deal prices express the quoted fineness."
            align="left"
            disableGutter
          />
        </Grid>
